...
class Category(Base):
    ...
    tasks = relationship("Task", back_populates="category", lazy="dynamic")
...
class Task(Base):
    ...
    attechments = relationship("Attechment", back_populates="task")
...
class Attechment(Base):
    ...
    user = relationship("User", back_populates="attechments")
